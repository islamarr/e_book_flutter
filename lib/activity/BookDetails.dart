    ...
    await isNetworkAvailable().then((bool) async {
      if (bool) {
        ...
        await getBookDetailsRestApi(request).then((res) async {
          ...
          mBookDetailsList = mCategory.map((model) => BookInfoDetails.fromJson(model)).toList();
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(fontSize: fontSizeLarge, color: appStore.appTextPrimaryColor, fontWeight: FontWeight.bold),
                                    ).visible(isSingleSampleFile(mBookDetailsData.attributes.length)).paddingOnly(left: 16, right: 16),
                  ...
                  Center(
                    child: Container(
                      child: Text(
                        ...
                        style: TextStyle(fontSize: fontSize25, color: appStore.appTextPrimaryColor, fontWeight: FontWeight.bold),
                      ),
                    ),
                  ),
                  Center(
