  ...
  void signInApi(req) async {
    ...
    await getLoginUserRestApi(req).then((res) async {
      ...
      if (res['profile_image'] != null) {
        setStringAsync(PROFILE_IMAGE, res['profile_image']);
      }
      ...
      print("Error" + error.toString() + this.data.toString());
      setState(() {
        isLoading = false;
      });
      if (error.toString() == "Invalid Credential.") {
        finish(context);
        print("Error1" + this.data.toString());
                    ...
                    child: Row(
                      children: <Widget>[
                        CountryCodePicker(
                          ...
                          boxDecoration: boxDecorationWithRoundedCorners(borderRadius: radius(4), backgroundColor: appStore.scaffoldBackground),
