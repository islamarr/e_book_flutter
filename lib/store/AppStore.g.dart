...
mixin _$AppStore on AppStoreBase, Store {
  ...
  final _$appTextPrimaryColorAtom =
      Atom(name: 'AppStoreBase.appTextPrimaryColor');
  ...
  final _$editTextBackColorAtom = Atom(name: 'AppStoreBase.editTextBackColor');
  ...
  final _$languageCodeAtom = Atom(name: 'AppStoreBase.languageCode');
  ...
  final _$isRTLAtom = Atom(name: 'AppStoreBase.isRTL');
  ...
  final _$pageAtom = Atom(name: 'AppStoreBase.page');
